    ...
    <div class="d-flex justify-content-center">
        <div class="card col-md-8" style="padding: 50px; margin-top: 100px;">
            <form method="post">
                ...
                <input type="text" class="form-control" placeholder="Masukan Lokasi Anda" name="locat"><br>
                <input type="text" class="form-control" placeholder="Masukan Tujuan Anda" name="tujuan"><br>
                <select id="driver" class="form-control" name="idd">
                    <option value="" selected disabled>Select Driver</option>
                    <?php
                        $data = tampil('driver');
                        while($d = mysqli_fetch_array($data)){
                    ?>
                    <option value="<?= $d['id_driver'] ?>" class="form-control"><?= $d['nm_driver'] ?></option>
                    <?php } ?>
                </select><br>
